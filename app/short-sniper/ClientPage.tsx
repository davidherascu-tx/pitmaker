...
const BASE_PRICE = 3995;
const STOCK_NUMBER = "PM-48-S"; 

const SPECS = [
  { label: "Main Chamber", value: "48″ x 24″", icon: Ruler },
  { label: "Grate Area", value: "3012 Sq. In.", icon: LayoutDashboard },
  { label: "Capacity", value: "8-10 Briskets", icon: Flame },
...
const STANDARD_FEATURES = [
  ...
  "Heavy Duty 4-1/2″ and 10″ Solid Rubber Casters w/ Lubricating Points."
];
...
const CUSTOM_OPTIONS = [
  ...
  { id: "add-10-inches", label: "Add 10″ to Cooking Chamber", price: 500, icon: Ruler, desc: "Extend your main chamber length for even more cooking capacity." }
];

export default function ShortSniperClient({ galleryImages }: { galleryImages: string[] }) {
    ...
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-[#EA580C] pt-24 pb-48 font-sans">
      ...
      <section className="relative container mx-auto px-6 py-12 md:py-20 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
        <div className="w-full lg:w-1/2 relative aspect-[4/3] rounded-[2.5rem] md:rounded-[3.5rem] bg-[#111111] border border-white/10 overflow-hidden shadow-2xl group">
          ...
          <Image 
            src="/images/smoker_short_sniper.webp" 
            alt="Short Sniper" 
            fill 
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <h1 className="font-oswald text-5xl md:text-7xl font-black text-white uppercase leading-[0.9] mb-6">
            Short <br /> <span className="text-zinc-500">Sniper</span>
          </h1>
          <p className="text-zinc-400 text-lg md:text-xl font-light leading-relaxed mb-8 max-w-xl">
            Here at Pitmaker we solved the traditional problems seen on offset firebox smokers—starting with smoke and heat leakage. Our revolutionary Smoke-Lock Technology™ gives the BBQ Cook the ultimate in cooking chamber temperature control. Smoke Your Target!™
          </p>
      ...
      <section className="container mx-auto px-6 mt-32 border-t border-white/5 pt-20">
         <div className="flex items-center justify-between mb-12">
            <div>
               ...
               <p className="text-zinc-500 font-light text-sm">See the Short Sniper in action.</p>
            </div>
         ...
         {galleryImages.length === 0 ? (
           <div className="w-full py-20 border border-dashed border-zinc-800 rounded-[2rem] flex flex-col items-center justify-center text-zinc-600">
              ...
              <p className="text-xs font-light mt-2">Upload images to <code className="bg-black px-2 py-1 rounded text-[#EA580C]">public/gallery/short-sniper/</code></p>
           </div>
         ) : (
