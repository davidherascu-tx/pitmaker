...
export default async function SGTSniperPage() {
  ...
  try {
    if (process.env.NEXT_PUBLIC_SANITY_PROJECT_ID) {
      dbData = await client.fetch(`*[_type == "product" && modelName == "SGT Sniper Trailer"][0]`);
    }
  } catch (e) {
  ...
  const fallbackData = {
    ...
    options: dbData?.options || [
      { label: "Two Tone Frame & Boxes", price: 250, desc: "Add a secondary custom color from the Pitmaker chart." },
      { label: "Barrel Shroud for Sniper", price: 250, desc: "Custom Painted Steel Plate on back of the Sniper Smoker Cooking Chamber." },
      ...
      { label: "20\" x 24\" Tailgater Charcoal Grill", price: 895, desc: "Standard carbon steel Tailgater grill mounted to your rig.", group: "tailgater" },
      { label: "Solid Stainless Tailgater Grill", price: 1600, desc: "Premium solid stainless steel upgrade for the Tailgater.", group: "tailgater" },
  ...
  return <SGTSniperClient galleryImages={galleryImages} cmsData={fallbackData} />;
}