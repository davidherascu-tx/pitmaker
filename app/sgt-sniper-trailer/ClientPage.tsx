...
const CUSTOM_OPTIONS = [
  ...
  { id: "shroud", label: "Barrel Shroud for Sniper", price: 250, icon: ShieldCheck, desc: "Custom Painted Steel Plate on back of the Sniper Smoker Cooking Chamber." },
  ...
  { id: "tailgater", label: "20\" x 24\" Tailgater Charcoal Grill", price: 895, icon: Flame, desc: "Standard carbon steel Tailgater grill mounted to your rig." },
  { id: "ss-tailgater", label: "Solid Stainless Tailgater Grill", price: 1600, icon: ShieldCheck, desc: "Premium solid stainless steel upgrade for the Tailgater." },
...
export default function SGTSniperClient({ galleryImages }: { galleryImages: string[] }) {
