...
import { 
  ...
  Flame, ArrowRight, Camera, Plus, X, ChevronLeft, ChevronRight, LayoutDashboard, Zap
} from "lucide-react";

const BASE_PRICE = 5795;
const STOCK_NUMBER = "PM-BBQ-EDGE"; 
...
const STANDARD_FEATURES = [
  "Fully insulated offset firebox answering the call for a heavy smoke cabinet smoker.",
  "Top reverse flow feature for even heat distribution and natural draw.",
  "Color Paint Choice with Zinc Epoxy Primer Included.",
  "14 Ga. Solid Stainless Steel Insulated Cooking Chamber & Firebox Doors.",
  "11 Ga. “P & O” Carbon Steel Body and Firebox, Welded Seamless.",
  "Solid Stainless 1″ x 1″ Tubular Handles.",
  ...
  "Solid Stainless Steel Drip Pan.",
  "1-1/4″ Heavy Duty Ball Valve Drain and 2″ Ball Valve Drain for Air Intake."
];

const CUSTOM_OPTIONS = [
  { id: "all-stainless", label: "All Solid Stainless Steel", price: 7800, icon: ShieldCheck, desc: "Make your entire Edge Smoker out of solid stainless steel." },
  { id: "stainless-grates", label: "Solid Stainless Cooking Grates", price: 800, icon: ShieldCheck, desc: "Upgrade all 5 grates to solid stainless steel (for Commercial Application)." },
  ...
  { id: "extra-grate", label: "Extra Cooking Grate (Installed)", price: 150, icon: LayoutDashboard, desc: "Add an extra cooking grate with additional installed channel." },
  ...
  { id: "deflector", label: "Deflector/Diverter Plate", price: 60, icon: Settings, desc: "Plate for inside the firebox to slow evaporation during water cooking." }
];

export default function EdgeClient({ galleryImages }: { galleryImages: string[] }) {
    ...
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-[#EA580C] pt-24 pb-48 font-sans">
      ...
      <section className="relative container mx-auto px-6 py-12 md:py-20 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
        <div className="w-full lg:w-1/2 relative aspect-[4/3] rounded-[2.5rem] md:rounded-[3.5rem] bg-[#111111] border border-white/10 overflow-hidden shadow-2xl group">
          ...
          <Image 
            src="/images/smoker_edge.webp" 
            alt="Pitmaker Edge Smoker" 
            fill 
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <h1 className="font-oswald text-5xl md:text-7xl font-black text-white uppercase leading-[0.9] mb-6">
            The <br /> <span className="text-zinc-500">Edge</span>
          </h1>
          <p className="text-zinc-400 text-lg md:text-xl font-light leading-relaxed mb-8 max-w-xl">
            The literal “cutting Edge” of BBQ smoker design. Get all the heavy smoke characteristics of your favorite offset side-firebox smoker with the unmatched efficiency and temperature retention of a fully insulated cabinet smoker.
          </p>
      ...
      <section className="container mx-auto px-6 mt-32 border-t border-white/5 pt-20">
         <div className="flex items-center justify-between mb-12">
            <div>
               ...
               <p className="text-zinc-500 font-light text-sm">See the Edge in action.</p>
            </div>
         ...
         {galleryImages.length === 0 ? (
           <div className="w-full py-20 border border-dashed border-zinc-800 rounded-[2rem] flex flex-col items-center justify-center text-zinc-600">
              ...
              <p className="text-xs font-light mt-2">Upload images to <code className="bg-black px-2 py-1 rounded text-[#EA580C]">public/gallery/smokers-edge/</code></p>
           </div>
         ) : (
