...
const BASE_PRICE = 5995;
const STOCK_NUMBER = "PM-SAFE-GM-COMBO"; 

const SPECS = [
  { label: "Smoker Area", value: "1230 Sq. In.", icon: LayoutDashboard },
  { label: "Grill Area", value: "1148 Sq. In.", icon: LayoutDashboard },
  { label: "Total Width", value: "87\" Overall", icon: Ruler },
  { label: "Weight", value: "850 lbs", icon: Settings }
];

const STANDARD_FEATURES = [
  "Combines the iconic BBQ Safe Smoker and GM-30 Grill-Meister onto one cart.",
  "14 Ga. Solid Stainless Steel Insulated Cooking Chamber Doors on Smoker.",
  "Heavy Duty Slide-Out Firegrate and Cooking Grates.",
  "Solid Stainless Steel Water Reservoir with 1-1/4″ Heavy Duty Ball Valve Drain.",
  "Solid Stainless Steel Charcoal Basket Frame on the Grill-Meister.",
  "Stainless Steel Roll-Top Lid on Grill—Easy to open.",
  "2″ Ball Valve Drain for Air Intake Damper for Precision Oxygen Control.",
  "Heavy Duty solid rubber 10″ wheels and 4″ rubber swivel casters for easy maneuverability."
];

const CUSTOM_OPTIONS = [
  { id: "stainless-safe", label: "All Stainless BBQ Safe Upgrade", price: 3000, icon: ShieldCheck, desc: "Upgrade the smoker portion of the combo to solid stainless steel." },
  { id: "prep-table", label: "Stainless Steel Slide-On Prep Table", price: 135, icon: Hammer, desc: "Removable solid stainless prep surface for the Grill-Meister side." },
...
export default function SafeComboClient({ galleryImages }: { galleryImages: string[] }) {
  ...
  const handleAddToQuote = () => {
    ...
    const newItem = {
      ...
      model: "Safe/Grill-Meister Combo",
      stock: STOCK_NUMBER,
      total: currentTotal,
    ...
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-[#EA580C] pt-24 pb-48 font-sans">
      ...
      <section className="relative container mx-auto px-6 py-12 md:py-20 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
        <div className="w-full lg:w-1/2 relative aspect-[4/3] rounded-[2.5rem] md:rounded-[3.5rem] bg-[#111111] border border-white/10 overflow-hidden shadow-2xl group">
          ...
          <Image 
            src="/images/smoker_safe_grill.webp" 
            alt="Safe/Grill-Meister Combo" 
            fill 
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          <div className="flex flex-wrap items-center gap-4 mb-6 self-start">
            <div className="inline-flex items-center gap-2 bg-[#EA580C] text-black px-4 py-1.5 rounded-full shadow-lg">
               <Zap size={14} />
               <span className="text-[10px] font-black uppercase tracking-widest">Ultimate Combo</span>
            </div>
          ...
          <h1 className="font-oswald text-5xl md:text-7xl font-black text-white uppercase leading-[0.9] mb-6">
            Safe & Grill <br /> <span className="text-zinc-500">Combo</span>
          </h1>
          <p className="text-zinc-400 text-lg md:text-xl font-light leading-relaxed mb-8 max-w-xl">
            Here is an all-in-one BBQ Smoker/Grill combo to fit all of your outdoor cooking needs! Whether it be for a BBQ Cook-off or the backyard, this combo takes two of your favorite pieces of outdoor cooking equipment and puts them onto one massive, mobile chassis.
          </p>
      ...
      <section className="container mx-auto px-6 mt-32 border-t border-white/5 pt-20">
         <div className="flex items-center justify-between mb-12">
            <div>
               ...
               <p className="text-zinc-500 font-light text-sm">See the Safe Combo in action.</p>
            </div>
         ...
         {galleryImages.length === 0 ? (
           <div className="w-full py-20 border border-dashed border-zinc-800 rounded-[2rem] flex flex-col items-center justify-center text-zinc-600">
              ...
              <p className="text-xs font-light mt-2">Upload images to <code className="bg-black px-2 py-1 rounded text-[#EA580C]">public/gallery/safe-grill-meister-combo/</code></p>
           </div>
         ) : (
