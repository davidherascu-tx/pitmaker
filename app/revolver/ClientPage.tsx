...
// --- REVOLVER SMOKER DATA ---
const BASE_PRICE = 2395;
const STOCK_NUMBER = "PM-Revolver-20x32"; 

const SPECS = [
  { label: "Main Chamber", value: "20” x 32”", icon: Ruler },
  { label: "Grate Area", value: "840 Sq. In.", icon: LayoutDashboard },
  { label: "Material", value: "1/4\" Plate Steel", icon: ShieldCheck },
  { label: "Mobility", value: "Heavy Duty Casters", icon: Truck }
];

const STANDARD_FEATURES = [
  "Slide-Out Cooking Grates and Fold-Up Expanded Metal Front Shelf included.",
  ...
  "4 Heavy Duty Casters with Lubricating Points for Easy Moving."
];

const CUSTOM_OPTIONS = [
  { id: "stainless-shelf", label: "Stainless Steel Front Shelf", price: 200, icon: Hammer, desc: "Upgrade the standard expanded metal front shelf to solid stainless steel." },
  { id: "ball-valve", label: "Ball Valve Drain", price: 30, icon: Droplet, desc: "Add a precision ball valve for easy grease and water draining." }
];

export default function RevolverClient({ galleryImages }: { galleryImages: string[] }) {
    ...
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-[#EA580C] pt-24 pb-48 font-sans">
      ...
      <section className="relative container mx-auto px-6 py-12 md:py-20 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
        <div className="w-full lg:w-1/2 relative aspect-[4/3] rounded-[2.5rem] md:rounded-[3.5rem] bg-[#111111] border border-white/10 overflow-hidden shadow-2xl group">
          ...
          <Image 
            src="/images/smoker_revolver.webp" 
            alt="Pitmaker Revolver Smoker" 
            fill 
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <h1 className="font-oswald text-5xl md:text-7xl font-black text-white uppercase leading-[0.9] mb-6">
            Revolver <br /> <span className="text-zinc-500">Smoker</span>
          </h1>
          <p className="text-zinc-400 text-lg md:text-xl font-light leading-relaxed mb-8 max-w-xl">
            We use only virgin, brand new pipe steel that has been stored indoors and never exposed to corrosion. Constructed out of ¼” plate steel, the Revolver is extremely durable, offering high-end enthusiast features at an unbeatable price point.
          </p>
          ...
          <div className="lg:col-span-4 sticky top-32 z-20">
             <div className="bg-[#111111] rounded-[2.5rem] border border-white/10 shadow-2xl p-8 overflow-hidden relative">
                ...
                <div className="flex justify-between items-center mb-4 text-sm text-zinc-300">
                  <span>Base Revolver Smoker</span>
      ...
      <section className="container mx-auto px-6 mt-32 border-t border-white/5 pt-20">
         <div className="flex items-center justify-between mb-12">
            <div>
               ...
               <p className="text-zinc-500 font-light text-sm">See the Revolver in action.</p>
            </div>
         ...
         {galleryImages.length === 0 ? (
           <div className="w-full py-20 border border-dashed border-zinc-800 rounded-[2rem] flex flex-col items-center justify-center text-zinc-600">
              ...
              <p className="text-xs font-light mt-2">Upload images to <code className="bg-black px-2 py-1 rounded text-[#EA580C]">public/gallery/smokers-revolver/</code> to see them here.</p>
           </div>
         ) : (
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {galleryImages.map((imgSrc, idx) => (
                 ...
                 >
                    <Image 
                      src={imgSrc} 
                      alt={`Revolver Gallery Image ${idx + 1}`} 
                      fill 
