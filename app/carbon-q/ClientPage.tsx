...
const CUSTOM_OPTIONS = [
  { id: "insulated", label: "Insulated Version", price: 1500, icon: Flame, desc: "Double the burn time at the same temperature with similar fuel. Great for outdoor kitchens." }
];

export default function CarbonQClient({ galleryImages }: { galleryImages: string[] }) {
