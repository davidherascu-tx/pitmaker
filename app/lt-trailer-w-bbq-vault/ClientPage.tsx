...
// --- 1. LT VAULT TRAILER DATA ---
const BASE_PRICE = 9995;
const STOCK_NUMBER = "LT-1-AXLE-VAULT"; 
...
const STANDARD_FEATURES = [
  ...
  "Two Stainless Steel Food Prep Tables with Lockable Dry Storage Box.",
...
const CUSTOM_OPTIONS = [
  ...
  { id: "nose-table", label: "Trapezoid Nose Stainless Table", price: 1195, icon: Hammer, desc: "Includes lockable storage box underneath." },
  { id: "large-table", label: "Large 58”x30” Stainless Prep Table", price: 895, icon: Hammer, desc: "With 58” L x 20″ x 20″ Lockable Storage Box Underneath." },
  ...
  { id: "ss-30-meister", label: "Solid Stainless 30” Grill-Meister", price: 4600, icon: ShieldCheck, desc: "Premium solid stainless steel upgrade for the 30\" Grill-Meister." },
...
export default function LTVaultClient({ galleryImages }: { galleryImages: string[] }) {
    ...
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-[#EA580C] pt-24 pb-48 font-sans">
      ...
      <section className="relative container mx-auto px-6 py-12 md:py-20 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
        <div className="w-full lg:w-1/2 relative aspect-[4/3] rounded-[2.5rem] md:rounded-[3.5rem] bg-[#111111] border border-white/10 overflow-hidden shadow-2xl flex items-center justify-center p-8 group">
          ...
          <Image 
            src="/images/LT_Trailer_BBQ_Vault.webp" // Default fallback image
            alt="LT Trailer w/ BBQ Vault" 
            fill 
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <h1 className="font-oswald text-5xl md:text-7xl font-black text-white uppercase leading-[0.9] mb-6">
            LT Trailer <br /> <span className="text-zinc-500">w/ Vault</span>
          </h1>
          <p className="text-zinc-400 text-lg md:text-xl font-light leading-relaxed mb-8 max-w-xl">
            This Pitmaker BBQ trailer fits any budget and leaves massive room for custom configuration. Very modular in nature and design. Whether its smokers, charcoal grills, burners, or fryers, we will help you design the ultimate competition or tailgate rig.
          </p>
          ...
          <div className="lg:col-span-4 sticky top-32 z-20">
             <div className="bg-[#111111] rounded-[2.5rem] border border-white/10 shadow-2xl p-8 overflow-hidden relative">
                ...
                <div className="flex justify-between items-center mb-4 text-sm text-zinc-300">
                  <span>Base LT Trailer w/ Vault</span>
      ...
      <section className="container mx-auto px-6 mt-32 border-t border-white/5 pt-20">
         <div className="flex items-center justify-between mb-12">
            <div>
               ...
               <p className="text-zinc-500 font-light text-sm">See the LT Trailer w/ Vault in action.</p>
            </div>
         ...
         {galleryImages.length === 0 ? (
           <div className="w-full py-20 border border-dashed border-zinc-800 rounded-[2rem] flex flex-col items-center justify-center text-zinc-600">
              ...
              <p className="text-xs font-light mt-2">Upload images to <code className="bg-black px-2 py-1 rounded text-[#EA580C]">public/gallery/lt-trailer-w-bbq-vault/</code> to see them here.</p>
           </div>
         ) : (
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {galleryImages.map((imgSrc, idx) => (
                 ...
                 >
                    <Image 
                      src={imgSrc} 
                      alt={`LT Vault Gallery Image ${idx + 1}`} 
                      fill 
