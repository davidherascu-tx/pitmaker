...
const SPECS = [
  { label: "Dimensions", value: "66.5″ H x 46″ W x 31.5″ D", icon: Ruler },
  { label: "Grate Area", value: "1230 Sq. In.", icon: LayoutDashboard },
  { label: "Capacity", value: "4 Briskets", icon: Flame },
  { label: "Weight", value: "460 lbs", icon: Settings }
];

const STANDARD_FEATURES = [
  "Mounted on robust prep cart for easy moving across all terrains.",
  ...
  "Solid Stainless Steel Water Reservoir for extra durability and corrosion resistance.",
      ...
      <section className="relative container mx-auto px-6 py-12 md:py-20 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <h1 className="font-oswald text-5xl md:text-7xl font-black text-white uppercase leading-[0.9] mb-6">
            Safe <br /> <span className="text-zinc-500">w/ Cart</span>
          </h1>
          <p className="text-zinc-400 text-lg md:text-xl font-light leading-relaxed mb-8 max-w-xl">
            The iconic BBQ Safe mounted on a robust prep cart for easy transport. Featuring the same 3/4″ high-temp gasket and insulation, the Safe w/ Cart gives you mobile competition-grade efficiency.
          </p>
      ...
      <section className="container mx-auto px-6 mt-32 border-t border-white/5 pt-20">
         <div className="flex items-center justify-between mb-12">
            <div>
               ...
               <p className="text-zinc-500 font-light text-sm">See the Safe w/ Cart in action.</p>
            </div>
