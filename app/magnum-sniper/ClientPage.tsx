...
const STOCK_NUMBER = "PM-MAG-SNIPER-24x48"; 

const SPECS = [
  { label: "Main Chamber", value: "24” x 48”", icon: Ruler },
  { label: "Grate Area", value: "2450 Sq. In.", icon: LayoutDashboard },
  { label: "Capacity", value: "10-14 Briskets", icon: Flame },
  { label: "Material", value: "1/4\" Plate Steel", icon: ShieldCheck }
];

const STANDARD_FEATURES = [
  "Massive Slide-Out Cooking Grates and Fold-Up Front Shelf included.",
  "Fully Insulated 24\" x 24\" Firebox for ultimate heat retention and fuel efficiency.",
...
export default function MagnumClient({ galleryImages, cmsData }: { galleryImages: string[], cmsData: any }) {
      ...
      <section className="relative container mx-auto px-6 py-12 md:py-20 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-zinc-400 text-lg md:text-xl font-light leading-relaxed mb-8 max-w-xl">
            The Magnum Sniper takes the traditional offset stick burner design and supercharges it with a massive, fully insulated firebox. This provides incredible fuel efficiency and rock-solid temperature stability, all while delivering that authentic heavy offset smoke flavor.
          </p>
      ...
      <section className="container mx-auto px-6 mt-32 border-t border-white/5 pt-20">
         <div className="flex items-center justify-between mb-12">
            <div>
               ...
               <p className="text-zinc-500 font-light text-sm">See the Magnum in action.</p>
            </div>
           ...
           <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6">
              {galleryImages.map((imgSrc, idx) => (
                 ...
                 >
                    <Image 
                      src={imgSrc} 
                      alt={`Magnum Sniper Gallery Image ${idx + 1}`} 
                      fill 
