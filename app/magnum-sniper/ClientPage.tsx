...
const STOCK_NUMBER = "PM-58-MAG"; 

const SPECS = [
  { label: "Main Chamber", value: "28″ x 58″", icon: Ruler },
  { label: "Grate Area", value: "4312 Sq. In.", icon: LayoutDashboard },
  { label: "Capacity", value: "10-20 Briskets", icon: Flame },
  { label: "Mobility", value: "Heavy Duty Casters", icon: Truck }
];

const STANDARD_FEATURES = [
  "Fully insulated double-walled firebox on all six sides.",
  "Firebox lined with Solid 1/4″ Thick Steel Plate welded seamless.",
  "Smoke-Lock Technology™ with double-walled insulated cooking chamber doors.",
  "Pitmaker Vortex Exhaust™ Smoke Stack System for increased convection.",
...
const CUSTOM_OPTIONS = [
  { id: "painted-firebox", label: "Painted Firebox (Sides & Top)", price: 200, icon: Settings, desc: "Add custom color to your firebox sides and top from our standard chart." },
...
export default function MagnumSniperClient({ galleryImages }: { galleryImages: string[] }) {
    ...
    <main className="min-h-screen bg-[#0a0a0a] selection:bg-[#EA580C] pt-24 pb-48 font-sans">
      ...
      <section className="relative container mx-auto px-6 py-12 md:py-20 flex flex-col lg:flex-row gap-12 lg:gap-20 items-center">
        <div className="w-full lg:w-1/2 relative aspect-[4/3] rounded-[2.5rem] md:rounded-[3.5rem] bg-[#111111] border border-white/10 overflow-hidden shadow-2xl group">
          ...
          <Image 
            src="/images/smoker_magnum_sniper.webp" 
            alt="Magnum Sniper" 
            fill 
        ...
        <div className="w-full lg:w-1/2 flex flex-col justify-center">
          <div className="flex flex-wrap items-center gap-4 mb-6 self-start">
            <div className="inline-flex items-center gap-2 bg-[#EA580C] text-black px-4 py-1.5 rounded-full shadow-lg">
               <Flame size={14} />
               <span className="text-[10px] font-black uppercase tracking-widest">Sniper Series</span>
            </div>
          ...
          <h1 className="font-oswald text-5xl md:text-7xl font-black text-white uppercase leading-[0.9] mb-6">
            Magnum <br /> <span className="text-zinc-500">Sniper</span>
          </h1>
          <p className="text-zinc-400 text-lg md:text-xl font-light leading-relaxed mb-8 max-w-xl">
            The most advanced offset firebox style smoker on the market. We combined a massive 4300+ sq. in. cooking chamber with a fully insulated double-walled firebox lined with solid 1/4″ thick steel plate for extreme efficiency and durability.
          </p>
      ...
      <section className="container mx-auto px-6 mt-32 border-t border-white/5 pt-20">
         <div className="flex items-center justify-between mb-12">
            <div>
               ...
               <p className="text-zinc-500 font-light text-sm">See the Magnum Sniper in action.</p>
            </div>
         ...
         {galleryImages.length === 0 ? (
           <div className="w-full py-20 border border-dashed border-zinc-800 rounded-[2rem] flex flex-col items-center justify-center text-zinc-600">
              ...
              <p className="text-xs font-light mt-2">Upload images to <code className="bg-black px-2 py-1 rounded text-[#EA580C]">public/gallery/magnum-sniper/</code></p>
           </div>
         ) : (
